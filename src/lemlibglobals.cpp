...
pros::MotorGroup right_motors({-13, 11, 12}, pros::MotorGearset::blue);
...
lemlib::ControllerSettings lateral_controller(9.5, // proportional gain (kP)
                                              0, // integral gain (kI)
...
lemlib::ControllerSettings angular_controller(3.03, // proportional gain (kP)
                                              0, // integral gain (kI)
