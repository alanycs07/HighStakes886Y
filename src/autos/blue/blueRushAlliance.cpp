...
void blueRushAlliance() {
  ...
  chassis.moveToPoint(50, 0, 500, {.maxSpeed = 40});
  chassis.waitUntilDone();
  // pros::delay(300);
  ...
  chassis.moveToPoint(24, -41, 700);
  chassis.turnToPoint(6, -46, 800, {.forwards = false});
  chassis.moveToPoint(6, -46, 800, {.forwards = false, .maxSpeed = 80});
  chassis.waitUntilDone();
  goalClamp.set_value(true);
  pros::delay(100);
